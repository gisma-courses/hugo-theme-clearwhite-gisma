...
weight: 3
slug: []
bibFile: /biblio/lidar/bib.json # path relative to project root
---
...
<p class="headline">  </p> 
<p class="textline">  * restart your rsession </p>
</br>
<p class="textline">  * clean the environment</p>
</div>
...
blogdown::shortcode("bibliography",.type = "html")
```
...
```{r echo=FALSE}
blogdown::shortcode("cite",  "test",.type = "html")
```
